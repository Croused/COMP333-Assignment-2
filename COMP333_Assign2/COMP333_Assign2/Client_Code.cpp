...
int main()
{
	...
	CandyMachine candyDispenser1(1.79, "Almond Joy", 40);
	...
	CandyMachine * candyDispenser2 = new CandyMachine(.75, "Hersheys", 30);
	...
	//	call polymorphic function showing costs of candyDispenser and drinkMachine objects
	cout << "9. Demonstrating calling polymorphic function\n";
